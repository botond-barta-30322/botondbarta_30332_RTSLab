package Application_4;
	...
	public class ExecutionThread3 extends Thread{
		...
		public ExecutionThread3(Integer monitor10,int activity_min, int activity_max, ExecutionThread1 thread1)
		{
		...
		public void run() {
		    ...
		    synchronized (monitor10) {
		    	try {
		        System.out.println(this.getName() + " - waiting for token from T6");
		        monitor10.wait();
